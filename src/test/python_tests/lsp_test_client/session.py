...
class LspSession(MethodDispatcher):
    ...
    def __enter__(self):
        ...
        # TODO(reiniscirpons): might be a possible issue with below line,
        # something to do with GC and valid file descriptors. Since its only a
        # test fixture, probably ok to ignore?
